...
?>
 ...
 <li>
<a href="rms.php?page=home"><i class="fa fa-fw fa-dashboard"></i>STUDENT</a>
</li>
<li>
...
<li>
    ...
    <ul class="collapse" id="recordsCollapse">
        <li>
            <a href="rms.php?page=records"><i class="fa fa-fw fa-files-o"></i>View Grade </a>
        </li>

    </ul>
</li>
<li>
    <a href="javascript:void(0)" data-toggle="collapse" data-target="#reportsCollapse"><i class="fa fa-fw fa-file"></i>Print Transcript      <i class="fa fa-fw fa-caret-down"></i></a>
