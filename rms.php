...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header" style="background-color: pink">
                ...
                <a class="navbar-brand" href=""><b>&nbsp;&nbsp;&nbsp; <img src="chmsc.png" alt="..." width="5%">Model School Student Information Management System</b></a>
            </div>
            <!-- Top Menu Items -->
            ...
            $sql = mysqli_query($conn,"SELECT * FROM student_info where STUDENT_ID = '".$_SESSION['ID']."'");
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse"  style="background-color: PowderBlue">
            <?php 
            include 'db.php';
...
$page = $_GET['page'];
$pages = array('home', 'Students','register','reg', 'subjects','student_p','records','record','addrecord','report','program','statistical','form137','list_report','student_report','users','school_year','grade','advisers','database','candidates','candidates_list', 'candidates_report','logs');
if (!empty($page)) {
