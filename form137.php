...
<div style="margin-left:.5in;margin-right:.5in;margin-top:.1in;margin-bottom:.1in;line-height:1mm;">
		...
		<p><center><b>Student Report</b></center></p>

		  </div>
		  <div class="row">
		  <div class="col-md-12">
		  <center><p><b><h4>MODEL SCHOOL RECORDS</h4></b></p></center>
		  </div>
          </div>
          <div class="row">
		  <div class="col-md-12">
		...
		?>
			<tr>
				<td style="width:600px;font-size:12px">
					...
					<b style="font-size:13px;text-transform: uppercase;"><?php echo $row['FIRSTNAME']. " " .  $row['LASTNAME']; ?></b>
					<br>
			...
			<td style="width:800px;font-size:12px">
					...
					<label for="">where completed :&nbsp</label>
