...
<table>
	<tr>
		...
		<td style="width:20%;">
			...
			?>
			<label style="font-size:13px">RegNo#:</label>
			<label style="font-size:13px" for=""><?php echo $row['REG_NO'] ?></label>
			<?php 
			} ?>
		</td>
	</tr>
		...
		?>
			<tr>
				<td style="width:600px;font-size:12px">
					...
					<b style="font-size:17px;text-transform: uppercase;"><?php echo $row['MIDDLENAME'].", " .  $row['LASTNAME']. " " .  substr("$mid",0,1) . "."; ?></b>
					<br>
			...
			<td style="width:800px;font-size:12px">
					...
					<label for="">where completed at:&nbsp</label>
					<h style="text-transform: capitalize"><?php echo $row['WHERE_COMP'] ?></h>
